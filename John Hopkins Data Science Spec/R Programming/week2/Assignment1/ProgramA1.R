...
pollutantmean <- function(directory, pollutant, id=1:332) {
    if (pollutant == "sulfate"){ #$ operator cant take a string argument; must be done by index.
      colIndex = 2
...
#Purpose: Calculate the correlation nitrate and sulfate  for each monitor above a given
#threashold.
#Output: Vector of sulfate/nitrate correlations per monitor, or a numeric(0) if thresh too high.
